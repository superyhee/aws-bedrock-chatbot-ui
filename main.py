...
with gr.Blocks(theme=small_and_beautiful_theme) as demo:
    ...
    with gr.Row(elem_id="chuanhu-header"):
        gr.HTML(get_html("header_title.html").format(
            app_title=i18n("Bedrock ChatUI")), elem_id="app-title")
        ...
        with gr.Group(elem_id="chuanhu-popup"):
            with gr.Group(elem_id="chuanhu-setting"):
                ...
                with gr.Tabs(elem_id="chuanhu-setting-tabs"):
                    ...
                    with gr.Tab(i18n("网络"),visible=False):
                        gr.Markdown(
                    ...
                    with gr.Tab(label=i18n("关于"), elem_id="about-tab",visible=False):
                        gr.Markdown(
            ...
            with gr.Group(elem_id="chuanhu-training",visible=False):
                with gr.Row():
                    gr.Markdown("## "+i18n("训练"))
                    gr.HTML(get_html("close_btn.html").format(
                        obj="box"), elem_classes="close-btn")
